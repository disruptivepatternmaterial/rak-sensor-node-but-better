...
| `CIT-RK900-BAUD-2026-08-03` | RK900-09 bus scan at multiple baud rates (2026-08-03 busscan image) | docs/EVIDENCE.md | docs/EVIDENCE.md entry 2026-08-03 | CRC-valid reply observed at 9600 only, not 4800. Sensor factory default is 9600 per manufacturer (Rika RK900-09 spec). Reconciles the baud discrepancy between RAKwireless datasheet (4800) and observed bench reply (9600). | VERIFIED 2026-08-03 |
