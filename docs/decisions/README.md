...
| [0011](ADR-0011-no-current-across-the-plug-while-mating.md) | No current crosses the pack plug while it is mated or unmated: load disconnect `S1` on `P+` | Proposed — accepted when the coreless mating test passes |
