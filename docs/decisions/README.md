...
| [0011](ADR-0011-plug-moves-only-with-no-core-fitted.md) | The pack plug is mated before the core is fitted and never moved with a core in the board; the mating excursion is measured and finds no pad. No switch — the enclosure is sealed. | Proposed 2026-09-05 |
